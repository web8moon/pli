    ...
    <div class="card text-center">
        ...
        <div class="card-body">
            ...
            if (isset($parts['NumbersOfRowsInSelect'])) {
                ...
                <div class="container">
                    <div class="form-group row justify-content-center">
                        ...
                        if ($parts['NumbersOfRowsInSelect'] > 0) {
                            ...
                            <input type="hidden" id="stockPartsConfirmErase"
                                   value="<?php echo $stockPartsConfirmErase; ?>">
                            <?php
                        }
                        ?>
                ...
                <p class="card-text">
                    <small class="text-muted" id="updateDat">
        ...
        <div id="LoadModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" class="btn btn-info btn-sm">1. <small>Select file</small></button> &rarr;
                        <button type="button" disabled class="btn btn-outline-secondary btn-sm">2. <small>Point the cells</small></button> &rarr;
                        <button type="button" disabled class="btn btn-outline-secondary btn-sm">3. <small>Upload price</small></button>
                    </div>
                    <!-- Основное содержимое модального окна -->
                    <div class="modal-body">
        ...
        <div id="LoadModal2" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <button type="button" disabled class="btn btn-info btn-sm">1.
                            <small>Select file</small>
                        </button>&rarr;
                        <button type="button" class="btn btn-outline-secondary btn-sm">2.
                            <small>Point the cells</small>
                        </button>&rarr;
                        <button type="button" disabled class="btn btn-outline-secondary btn-sm">3. <small>Upload price</small></button>
                    </div>
                    <!-- Основное содержимое модального окна -->
