            ...
            if ($link) {
                ...
                if ($result = mysqli_query($link, $select)) {
                    if (mysqli_num_rows($result) == 1) {
                        ...
                        <div class="card-body">
                            <br>
                            <h5 class="card-title"><?php echo isset($profileAccountDetail) ? $profileAccountDetail : ''; ?></h5>
                            <br>
                            ...
                            <div class="card">
                                <div class="card-body"><br>
                                    ...
                                    <div class="form-group row">
                                        <label for="user-text-input"
                                               class="col-2 col-form-label"><?php echo isset($profileAccountName) ? $profileAccountName : 'Name'; ?></label>
                                        <div class="col-10">
